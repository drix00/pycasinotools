...
class Element:
    ...
    def get_total_xray_intensity_by_line_type(self, line, intensity_type=EMITTED):
        ...
        return intensities[line][intensity_type]
...
def get_atom(symbol):
    ...
    return atomic_number, rho, z, a, ef, kf, ep
